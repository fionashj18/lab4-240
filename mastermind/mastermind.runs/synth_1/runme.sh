...
HD_PWD='/afs/andrew.cmu.edu/usr20/fionas/private/18240/lab4/mastermind/mastermind.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ChipInterface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ChipInterface.tcl

...
HD_PWD='/afs/andrew.cmu.edu/usr20/fionas/private/18240/lab4/mastermind/mastermind.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ChipInterface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ChipInterface.tcl -notrace

...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/afs/andrew.cmu.edu/usr20/fionas/private/18240/lab4/mastermind/mastermind.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key hdmi_tx_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc hdmi_tx_0_simv.daidir vcs_lib c.obj)

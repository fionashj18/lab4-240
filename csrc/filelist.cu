...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _352721_archive_1.so
_352721_archive_1.so : archive.7/_352721_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_352721_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_352721_archive_1.so $@

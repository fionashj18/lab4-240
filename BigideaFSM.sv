...
module BigPictureFSM
    ...
    enum logic [2:0] {IDLE, LOAD_PATTERN, IN_GAME, GRADING, FINISH} currState, nextState;
    ...
    always_comb begin
        ...
        case (currState)
            ...
            LOAD_PATTERN: begin
                if (loadShapeNowSeen & ~finish_loading) begin
                    shape_loading = 1'b1;
                end 
